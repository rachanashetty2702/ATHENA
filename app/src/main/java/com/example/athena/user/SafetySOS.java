...
import com.example.athena.user.ServiceMine;
import com.example.athena.user.RegisterNumberActivity;
...
public class SafetySOS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_safety_sos);
    ...
    public void PopupMenu(View view) {
        PopupMenu popupMenu = new PopupMenu(SafetySOS.this,view);
        popupMenu.getMenuInflater().inflate(R.menu.popup,popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId() == R.id.changeNum){
                    startActivity(new Intent(SafetySOS.this,RegisterNumberActivity.class));
                }
                return true;
            }
        });
